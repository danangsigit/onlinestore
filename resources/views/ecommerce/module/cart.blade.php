...
<form action="{{ route('ecommerce.update_cart') }}" method="post">
@csrf
        <table class="table">
						<thead>
							<tr>
              ...
              @endforelse
                  ...
                  <a class="gray_btn" href="{{ route('ecommerce.product') }}">Continue Shopping</a>
                  <a class="main_btn" href="{{ route('ecommerce.checkout') }}">Proceed to checkout</a>
									</div>
								</td>
							</tr>
						</tbody>
